...
const features = [
  {
    title: 'WCAG‑aligned output',
    description:
      'Clear structure and safe defaults designed to meet WCAG 2.1 AA guidelines out of the box.',
    image: screenshotPayroll,
  },
  {
    title: 'Screen reader optimized',
    description:
      "Titles and descriptions tuned to sound right with NVDA, JAWS, and VoiceOver — never confusing.",
    image: screenshotExpenses,
  },
  {
    title: 'AI‑readable structure',
    description:
      'Semantic markup and JSON‑LD that help assistants understand and explain your content to users.',
    image: screenshotVatReturns,
  },
  {
    title: 'Community‑driven impact',
    description:
      'Built with feedback from users with disabilities and accessibility advocates; returns null when unsure.',
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          ...
          <p className="mt-6 text-lg tracking-tight text-teal-100">
            Help people with disabilities navigate your site — and help AI understand it.
          </p>
        </div>
        <TabGroup
              ...
              <TabPanels className="lg:col-span-7">
                {features.map((feature) => (
                  <TabPanel key={feature.title} unmount={false}>
                    ...
                    <div className="mt-10 w-180 overflow-hidden rounded-xl bg-slate-50 shadow-xl shadow-teal-900/20 sm:w-auto lg:mt-0 lg:w-271.25">
                      <Image
                        className="w-full"
                        src={feature.image}
                        alt=""
