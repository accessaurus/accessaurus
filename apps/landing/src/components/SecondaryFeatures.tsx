...
const features: Array<Feature> = [
  {
    ...
    summary: 'Titles and descriptions tested with NVDA, JAWS, and VoiceOver.',
    description:
      "If it doesn't sound right, we don't ship it. Clear language that makes sense when read aloud.",
    image: screenshotProfitLoss,
    icon: function A11yIcon() {
      let id = useId()
      return (
        <>
          <defs>
  ...
  },
  {
    name: 'Plain Language',
    summary:
      'Clear, simple language that’s easy to understand. No jargon.',
    description:
      'We optimize tone and clarity so content works without visual context and reduces cognitive load.',
    image: screenshotInventory,
    icon: function LanguageIcon() {
      return (
        <>
          <path
            opacity=".5"
  ...
  },
  {
    ...
    summary:
      'Proper heading hierarchy and semantic HTML that assistive tech can navigate.',
    description:
      'Better comprehension for AI assistants and better experiences for people using screen readers.',
    image: screenshotContacts,
    icon: function SemanticsIcon() {
      return (
        <>
          <path
            opacity=".5"
